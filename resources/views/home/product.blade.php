            ...
            <div class="card-body">
                <div class="row">
                    {{-- <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12">
                                <img src="https://source.unsplash.com/200x200?{{ $products->name }}"
                                    class="product-image" alt="Product Image">
                            </div>
                            <div class="col-12 product-image-thumbs">
                                <div class="product-image-thumb active"><img
                                        src="https://source.unsplash.com/200x200?{{ $products->name }}"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100"
                                        src="https://source.unsplash.com/400x400?{{ $product->name }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="https://source.unsplash.com/400x400?{{ $product->name }}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="https://source.unsplash.com/400x400?{{ $product->name }}" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="tab-content p-3" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                            ...
                            finibus purus sed venenatis. Vivamus varius metus quam, id dapibus velit mattis eu.
                            Praesent
                            ...
                            ante. Quisque interdum efficitur nunc vitae consectetur. Suspendisse venenatis, tortor
                            non
                        ...
                        <div class="tab-pane fade" id="product-comments" role="tabpanel"
                            ...
                            mauris ornare, eget porttitor enim vulputate. Mauris hendrerit, massa nec aliquam
                            cursus, ex
                            elit euismod lorem, vehicula rhoncus nisl dui sit amet eros. Nulla turpis lorem,
                            dignissim a
                            sapien eget, ultrices venenatis dolor. Curabitur vel turpis at magna elementum hendrerit
                            vel
                        ...
                        <div class="tab-pane fade" id="product-rating" role="tabpanel"
                            ...
                            elit.
                            In hac habitasse platea dictumst. Aenean elementum leo augue, id fermentum risus
                            efficitur
                            ...
                            Etiam dignissim aliquam ligula, aliquet feugiat nibh rhoncus ut. Aliquam efficitur
                            lacinia
                            lacinia. Morbi ac molestie lectus, vitae hendrerit nisl. Nullam metus odio, malesuada in
                            vehicula at, consectetur nec justo. Quisque suscipit odio velit, at accumsan urna
                            vestibulum
                            a. Proin dictum, urna ut varius consectetur, sapien justo porta lectus, at mollis nisi
                            orci
